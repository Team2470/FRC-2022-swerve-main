...
public class FieldConstants {
  ...
  public static final Pose3d[] CHARGING_STATION = {
    new Pose3d(
        Units.inchesToMeters(114.74),
        Units.inchesToMeters(155.39),
        0.0,
        new Rotation3d()), // bottom left
    new Pose3d(
        Units.inchesToMeters(162.74),
        Units.inchesToMeters(155.39),
        0.0,
        new Rotation3d()), // top left
    new Pose3d(
        Units.inchesToMeters(114.74),
        Units.inchesToMeters(59.39),
        0.0,
        new Rotation3d()), // top right
    new Pose3d(
        Units.inchesToMeters(114.74),
        Units.inchesToMeters(59.39),
        0.0,
        new Rotation3d()) // bottom right
  };
  ...
  public static void update() {
    if (DriverStation.getAlliance() != storedAlliance) {
      ...
      PORTAL =
          new Pose3d(
              FieldConstants.PORTAL_TAG_X, FieldConstants.PORTAL_TAG_Y, 0.0, new Rotation3d());
      ...
      COLUMN_TWO =
          new Pose3d[] {
            new Pose3d(
                LEFT_TAG_X + LOW_CUBE_X_CENTER_FROM_APRILTAG, LEFT_TAG_Y, 0.0, new Rotation3d()),
            new Pose3d(
      ...
      COLUMN_FIVE =
          new Pose3d[] {
            new Pose3d(
                MIDDLE_TAG_X + LOW_CUBE_X_CENTER_FROM_APRILTAG,
                MIDDLE_TAG_Y,
                0.0,
                new Rotation3d()),
            new Pose3d(
      ...
      COLUMN_EIGHT =
          new Pose3d[] {
            new Pose3d(
                RIGHT_TAG_X + LOW_CUBE_X_CENTER_FROM_APRILTAG, RIGHT_TAG_Y, 0.0, new Rotation3d()),
            new Pose3d(
